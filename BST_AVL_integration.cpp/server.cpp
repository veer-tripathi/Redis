...
static bool eq(Hnode* node, Hnode* key){
    struct Entry* le=container_of(node,Entry, node);
    struct LookupKey* re=container_of(key,LookupKey, key);
